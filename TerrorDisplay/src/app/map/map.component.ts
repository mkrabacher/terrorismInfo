...
// <script src="\node_modules\heatmap.js\build\heatmap.js"></script>
// <script src="\node_modules\heatmap.js\plugins\leaflet-heatmap\leaflet-heatmap.js"></script>
...
export class MapComponent implements OnInit {
    ...
    ngOnInit() {
        this.data = this.getPointsThroughService();
        const mapProp = {
    ...
    getPointsThroughService() {
        ...
        observable.subscribe(data => {
            ...
            for (let i = 0; i < data['attacks'].length; i++) {
                arr.push(new google.maps.LatLng(data['attacks'][i]['latitude'], data['attacks'][i]['longitude']));
            }
            console.log(arr);
    ...
    testData() {
        ...
        for (let i = 0; i < testData.length; i++) {
            arr.push(new google.maps.LatLng(testData[i]['latitude'], testData[i]['longitude']));
        }
        console.log(arr);
        return arr;
    }
